...
export const countrySlice = createSlice({
    ...
    reducers:{
        deleteCountry: (state, action)=>{
            ...
            state.countries = state.countries.filter(item=> item.name.official   !== action.payload )
            console.log(state.countries);
        },

        selectCt:(state,action)=>{
            state.selected= action.payload
        }
    }
})

export const { deleteCountry,selectCt } = countrySlice.actions
